...
//                 alert('Message sent! (mock)');
//                 // Reset form state
//                 setForm({ firstName: '', lastName: '', email: '', contact: '', message: '', proof: null });
//                 setFileName(''); // Also reset the file name display
//                 setTouched({});
//                 setIsSubmitting(false);
//                 e.target.reset(); // Natively reset the form to clear all fields including file input
//             }, 1500);
//         } else {
//             setTouched({ firstName: true, lastName: true, email: true, contact: true });
//         }
...
//                                             />
//                                             {/* This label is what the user sees and interacts with */}
...
//         if (form.proof) {
//             formData.append('proofs', form.proof);
//         }

//         // CORRECTED: Directly get the token using the correct key 'token'.
...
//         try {
//             const API_URL = 'https://it-con-backend.onrender.com/api/enquiries';
...
const ContactUsPreview = () => {
    ...
    if (form.proof) {
        formData.append('proof', form.proof); // ✅ match backend field name
    }
