...
import React, { useState } from 'react';
import './Venue.css'; // Import the new stylesheet
import { FaHotel, FaInfoCircle } from 'react-icons/fa'; // Import new icons
    ...
    return (
        <>
            <main className="venue-page">
                ...
                <section id="hostel-dining" className="content-section">
                    <h2>Hostel & Dining</h2>
                       <div className="content-box">
                            <table className="info-table">
                                <thead>
                ...
                <section id="accommodation-details" className="content-section">
