        ...
        <div className="journal-content">
          ...
          <main>
            ...
            <Section title="Journal Submission Process" icon={<ProcessIcon />}>
              <p>After acceptance, authors of selected papers will be invited to submit an extended version of their work to a dedicated journal. Each submission will undergo a rigorous peer-review process according to the journal’s standards.</p>
            </Section>
