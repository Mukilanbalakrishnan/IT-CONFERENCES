...
const TeamProfile = () => {
    ...
    const statusSteps = [
        { 
            name: 'Abstract', 
            status: profileData.abstractStatus === 'approved' ? 'completed' : (profileData.abstractStatus === 'rejected' ? 'rejected' : 'upcoming'),
            details: `Status: ${profileData.abstractStatus || 'Pending'}`, 
            icon: <FaFileAlt /> 
        },
        { 
            name: 'Final Paper', 
            status: profileData.finalPaperStatus === 'approved' ? 'completed' : (profileData.finalPaperStatus === 'rejected' ? 'rejected' : 'upcoming'),
            details: `Status: ${profileData.finalPaperStatus || 'Pending'}`, 
            icon: <FaFileAlt /> 
        },
        { 
            name: 'Payment', 
            status: profileData.paymentStatus === 'approved' ? 'completed' : (profileData.paymentStatus === 'rejected' ? 'rejected' : 'upcoming'),
            details: `Status: ${profileData.paymentStatus || 'Pending'}`, 
            icon: <FaCreditCard /> 
        },
    ];
    ...
    const UserDetail = ({ icon, label, value }) => (
        <div className="user-detail-item">
            <div className="user-detail-icon">{icon}</div>
